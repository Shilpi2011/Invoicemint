...
class EditClientDetail extends StatefulWidget {
  const EditClientDetail({super.key});

  @override
  State<EditClientDetail> createState() => _EditClientDetailState();
}

class _EditClientDetailState extends State<EditClientDetail> {
                    ...
                    boxShadow: [
                      ...
                      padding: const EdgeInsets.only(top:10,bottom:35,left: 20),
                        ...
                        child:const Icon(Icons.chevron_left,color: Colors.white,size: 30,),
                         ...
                         const Text('Edit Client Details',
                          style: TextStyle(
                             color:Colors.white,
                              fontSize:17,
